...
Bienvenue sur mon profil GitHub ! Je suis passionné par le développement logiciel et la création de projets innovants.
...
- **Frameworks** : .NET, OpenMPI
- **Outils** : Docker, GitHub, Google
...
| 2024 | Générateur de site web "roman". | 🎓 | 👤 | Python |
| 2023 | Application mobile d'éducation musicale. | 💼 | 👤 | C++, JUCE |
